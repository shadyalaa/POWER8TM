...
public:
    ...
    virtual int64_t stockLevel(TM_ARGDECL int64_t warehouse_id, int64_t district_id, int64_t threshold) = 0;
    ...
    virtual bool newOrderHome(TM_ARGDECL int64_t warehouse_id, int64_t district_id, int64_t customer_id,
            const std::vector<NewOrderItem>& items, const char* now,
            NewOrderOutput* output, TPCCUndo** undo, Item** item_tuples) = 0;
    ...
    // part of the RPC
    virtual bool newOrderRemote(TM_ARGDECL int64_t home_warehouse, int64_t remote_warehouse,
            const std::vector<NewOrderItem>& items, std::vector<int64_t>* out_quantities,
            TPCCUndo** undo, Item** item_tuples) = 0;

    static const int64_t INVALID_QUANTITY = -1;
    // Combines valid quantities into output.
    static void newOrderCombine(const std::vector<int64_t>& remote_quantities,
            NewOrderOutput* output);
    static void newOrderCombine(const std::vector<int64_t>& quantities,
    ...
    virtual bool hasWarehouse(TM_ARGDECL int64_t warehouse_id) = 0;
